"""Security and invariant test for Plan mode denies file modifications before exit (perm_plan_mode_readonly)."""
import pytest
...
def test_sec_perm_plan_mode_readonly(workspace: Path):
