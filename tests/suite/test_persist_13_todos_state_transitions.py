"""Unit test for Pending to in_progress to completed status transitions (todos_state_transitions)."""
import pytest
...
def test_todos_state_transitions(workspace: Path):
    # Test Pending to in_progress to completed status transitions
    ...
    item = mem.learn("Test convention for todos_state_transitions")
