"""Unit test for SessionStore JSONL append durability (session_jsonl_append)."""
import pytest
...
def test_session_jsonl_append(workspace: Path):
    # Test SessionStore JSONL append durability
    ...
    item = mem.learn("Test convention for session_jsonl_append")
