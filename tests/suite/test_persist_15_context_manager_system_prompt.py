"""Unit test for System prompt generation with project guidelines (context_manager_system_prompt)."""
import pytest
...
def test_context_manager_system_prompt(workspace: Path):
    # Test System prompt generation with project guidelines
    ...
    item = mem.learn("Test convention for context_manager_system_prompt")
