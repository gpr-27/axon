"""Unit test for Dropping specific queued message by index (queue_drop_item)."""
import pytest
...
def test_queue_drop_item(workspace: Path):
    # Test Dropping specific queued message by index
    ...
    item = mem.learn("Test convention for queue_drop_item")
